...
def data_exploration():
    ...
    st.markdown("""The highest correlation between parameters are between <span style="color: red;">V16, V17</span> and <span style="color: red;">V18</span>.""", unsafe_allow_html=True)
    ...
    st.markdown("""The <span style="color: red;">amounts</span> of money transferred in the transactions contained in or data set are <span style="color: red;">evenly distributed</span>.""", unsafe_allow_html=True)
