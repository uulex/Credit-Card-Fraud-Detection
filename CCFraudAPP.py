...
def fraud_detector():
    ...
    st.markdown("""Here you can use our <span style="color: red;">fraud detection tool</span> to check if a transaction was fraudulent or not. Just input the transaction information acording to our form and our <span style="color: red;">Random Forest</span>-Model will do the rest! """, unsafe_allow_html=True)
